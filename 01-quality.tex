...
% Some systems detect only rather coarse objects like the floor, the ceiling and walls in 3D laser
% scans~\cite{nuechter08semanticmaps}, or focus on distinguishing different kinds of rooms based
% on the objects inside~\cite{vasudevan07cognitive} or spatial relations between them~\cite{TriebelAMN07}.
% Other methods, like~\cite{Rusu08RAS2}
% or \cite{ekvall07objectdetection} detect, identify and localize objects in the scene and therefore
% create the basis for more abstract representations. However,
...
the following four subgoals of the project: \\
...
\todo{Rephrase to correspond to the teaser pic on the first page}
...
\todo{Pieter: Above like description for you and Ken}
