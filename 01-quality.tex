...
loading  the  dishwasher and simulating the shopping task (see Figure~\ref{fig:teaser}, \todo{video}).
...
\todo{include my both humanoids papers}
...
\todo{include my IROS 2011 paper}
...
\item[Task 2.1: Object Detection and Perception] In this task, we will
  ...
  \todo{include paper by Blodow, Jain}
...
\textbf{WP 3: Acquisition and Learning of \ksem\ semantic object maps}
